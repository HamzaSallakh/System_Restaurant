...
namespace Restaurant.Components
{
    ...
    public class HomeController : Controller
    {
        ...
        public ITransactionBookTableRepositorie ITransactionBookTableRepositorie { get; }
        ...
        public HomeController(ICategoryMenuRepositorie _Category,IServiceRepositorie _service ,IMenuRepositorie _Menu, ISystemSettingRepositorie _SystemSetting, ISliderRepositorie _Slider, ItemMenuRepositorie _Items, IOfferRepositorie _offer, IPartnerRepositorie _Partner, IWorkingHourRepositorie _MasterWorkingHours, ISocialMediuauRepositorie _Meida, ITransactionContactUsRepositorie _ITransactionContactUsRepositorie, IOfferRepositorie _IOfferRepositorie, ITransactionBookTableRepositorie _ITransactionBookTableRepositorie)
        {
            ...
            ITransactionBookTableRepositorie = _ITransactionBookTableRepositorie;
            service = _service;
            Category = _Category;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Reserevation(MV_Front collection)
        {
            try
            {
                ...
                collection.TransactionBookTable.IsDelete = 0;
                collection.TransactionBookTable.CreateId = "1";
                collection.TransactionBookTable.CreateDate = DateTime.Now;
                collection.TransactionBookTable.EditDate = DateTime.Now;
                collection.TransactionBookTable.EditId = "1";



                ITransactionBookTableRepositorie.Add(collection.TransactionBookTable);
